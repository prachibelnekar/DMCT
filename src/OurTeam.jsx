    ...
    return (
        <>
            <div className="flex overflow-hidden flex-col bg-white">
                <div className="flex flex-col items-center self-end mt-16 mr-16 mx-20 w-full max-w-[1285px] max-md:mt-10 max-md:mr-2.5 max-md:max-w-full">
                    <div className="self-start w-full max-w-[1219px] max-md:max-w-full">
                        <div className="flex gap-0 max-md:flex-col bg-red-500 h-[500px]">
                            {/* Image Section */}
                            <div className="w-[50%] max-md:w-full">
                                <img
                                    src={dr}
                                    alt="Dr. Ravindra Jadhav"
                                    className="w-[350px] h-[400px] mt-14  bg-cover ml-40"
                                />
                            </div>

                            {/* Information Box Section */}
                            <div className="flex flex-col ml-5 w-[800px] absolute max-md:ml-0 max-md:w-full border-2 border-sky-500 p-5 rounded-lg  ">
